<?php 
	...
	include "../config/connect.php";
			...
			$fullname = $phone = $email = $message = $nameErr = $phoneErr = $emailErr = $messageErr = "";
			if ($_SERVER["REQUEST_METHOD"] == "POST") {
				...
				if (empty($phone)) {
					$phoneErr = "Phone is not empty";
				}

				if (empty($message)) {
					$messageErr = "Message is not empty";
				}
				...
				if (empty($nameErr) && empty($phoneErr) && empty($emailErr) && empty($messageErr)) {
					$insertContact = mysqli_query($conn,"INSERT INTO `contact_reply` (`name`, `phone`, `email`, `message`, `created_time`) VALUES ('$fullname', '$phone', '$email', '$message', '".date("yy-m-d")."')");
				}
						 	...
						 	<form action="" method="POST">
						          <div class="contact-form">
									<div class="contact-to">
				                     	...
				                     	placeholder="<?= empty($nameErr) ? 'fullname' : $nameErr?>">

									 	<input type="text"  name="phone" 
									 	placeholder="<?= empty($phoneErr) ? 'phone' : $phoneErr?>">

									 	<input type="text" name="email" 
									 	placeholder="<?= empty($emailErr) ? 'email' : $emailErr?>">
									</div>
